...
```json
{
  ...
  "body": {
    ...
    "total_askp_rsqn": "604",     // 총 매도잔량
    "total_bidp_rsqn": "854",     // 총 매수잔량
    ...
    "high": "72500",              // 고가
    "low": "70500",               // 저가
    "last": "71700",              // 현재가 (직전 체결가)
    "vol": "1234567",             // 누적 거래량
    "value": "78900000000",       // 누적 거래대금

    "time": "180015",             // HHMMSS 기준
    "date": "20251014",           // YYYYMMDD 기준
    "sign": "2",                  // 전일대비구분 (1:상한, 2:상승, 3:보합, 4:하락, 5:하한)
    "change": "500",              // 전일 대비 등락폭
    "drate": "0.70"               // 등락률 (%)
  }
}
